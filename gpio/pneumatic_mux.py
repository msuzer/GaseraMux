...
from system.log_utils import info, debug, warn
...
class PneumaticMux:
    ...
    def home(self) -> int:
        ...
        self._delay_ms(self.timing.home_settle_ms)
        self.position = 0
...
class CascadedMux:
    ...
    def select_next(self) -> int:
        ...
        info("[CMUX] advanced", virtual=self._virtual_index,
